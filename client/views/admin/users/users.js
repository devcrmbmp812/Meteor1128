...
Template.AdminUsersViewTableItems.events({
	...
	"click #delete-button": function(e, t) {
		...
		var me = this;
		bootbox.dialog({
			message: "Are you sure you want to delete this user? All listing belonging to this user will also be deleted",
			title: "Delete",
			animate: false,
			buttons: {
				success: {
					...
					callback: function() {
						...
						Meteor.call("deleteUserAccount", me._id, function(e) { 
						  var userListings = Listings.find({customer: me._id});
						  _.forEach(userListings, function(ul) {
						    Listings.remove({_id: ul._id});
						  });
